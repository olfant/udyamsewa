   ...
   <script type="application/ld+json">
      {
         ...
         "mainEntity": {
            "@type": "Service",
            "name": "MSME/Udyam Registration Service - OTP Submitted",
            "serviceType": "Business Registration - OTP Submitted",
            "provider": {
               "@type": "Organization",
               "name": "UdyamGov",
...
<body>
   ...
   <div class="container p-0 rescon"
      style="max-width:32%;
            margin:40px auto;
