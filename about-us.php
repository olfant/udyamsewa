...
<head>
    ...
    <script type="application/ld+json">
        ...
        "@type": "PostalAddress",
        "streetAddress": "",
        "addressLocality": "2nd floor (Olfant), Kaizen Heights, Tata Kandra Main Road, N-395 & N-396, Adityapur Industrial Area, Saraikela Kharsawan, Jharkhand, India",
        "addressCountry": "IND",
...
<div class="container content-page-wrapper mb-5">
  ...
  <section>
            ...
            <h2>Why Choose Us?</h2>
            <ul>
                <li>Easy and fast online registration process</li>
                <li>Expert support throughout the registration journey</li>
                <li>Dedicated to compliance with MSME regulations</li>
  ...
  <table class="table">
      ...
      <tbody>
          <tr>
              <td>NEW UDYAM REGISTRATION</td>
              <td>1349</td>
          </tr>
          <tr>
              <td>UDYAM RE-REGISTRATION</td>
              <td>1349</td>
          </tr>
          <tr>
              <td>UPDATE UDYAM CERTIFICATE</td>
              <td>999</td>
          </tr>
          <tr>
              <td>FORGOT UDYAM REGISTRATION</td>
              <td>649</td>
          </tr>
          <tr>
              <td>PRINT UDYAM CERTIFICATE</td>
              <td>649</td>
          </tr>
          <tr>
              <td>UDYAM Annexure CERTIFICATE</td>
              <td>649</td>
          </tr>
          <tr>
              <td>CANCEL UDYAM REGISTRATION</td>
              <td>649</td>
          </tr>
      </tbody>
  </table>
