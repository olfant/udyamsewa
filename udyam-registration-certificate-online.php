   ...
   <body>
      ...
      <section id="-registration">
         <div class="container custom-form-container pt-4">
               ...
               <div class="col-lg-7 col-md-12">
                  <div class="card rounded-0">
                     <div class="card-header rounded-0 text-center p-2 text-white brown">
                        <h2 style="font-size:19px; font-weight: bold;">Udyam Registration Form</h2>
                     </div>
                     <div class="card-body rounded-0 p-1">
                        <form id="main-form" action="submit.php" method="post" enctype="multipart/form-data">
                           ...
                           <div class="form-group txt">
                              ...
                              <select class="form-control" name="gst_avl">
                                 <option value="--Select--" disabled selected hidden>--Select--</option>
               ...
               <div class="col-lg-5 col-md-12 mt-4 mt-lg-0">
                  <div class="card card_instruction">
                     <div class="card-header text-center">
                        <h3>READ THE INSTRUCTIONS TO FILL UDYAM REGISTRATION FORM</h3>
                     </div>
                     <div class="card-body rounded-0 p-0">
                        <div class="form-instructions">
                           <div class="form-group" style="margin-top: 0px;">
                              <label class="fcs-text-dark"><strong>Applicant Name :</strong> APPLICANT MUST ENTER THEIR NAME AS IT APPEARS ON THEIR AADHAAR CARD, ISSUED BY UIDAI.&nbsp;
                           ...
                           <div class="form-group" style="margin-top: 20px;">
                              <label class="fcs-text-dark"><strong>Email Id :</strong> APPLICANT MUST ENTER THEIR EMAIL ADDRESSES SO THE CERTIFICATE AND ACKNOWLEDMSMEENT WILL BE SENT TO THEIR REGISTERED EMAIL ADDRESSES. &nbsp;
                  ...
                  <div class="card card_instruction mt-4">
                        <div class="card-header text-center">
                           <h3>OTP REQUIREMENT FOR PROCESSING NEW UDYAM REGISTRATION</h3>
                        </div>
                        <div class="card-body rounded-0 p-0">
                           <div class="form-instructions blink">
                              <div class="form-group m-0">
                                    <p class="f12 form-help h5" style="color: red;">1. While Aadhaar Card Validation.</p>
                                    <p class="f12 form-help h5" style="color: red;">2. While final Submission of the Application.</p>
                                    <p class="f12 form-help h5 mb-0" style="color: red;">3. While Printing the Certificate.</p>
                              </div>
                           </div>
                        </div>
                        </div>
            ...
            <h3>Process to Apply for Udyam Registration for MSME</h3>

            <p><span style="background-color: yellow; font-style: italic;">Udyam is an online registration platform launched by the Ministry of MSME in 2006 through which the government classifies businesses into micro, small, and medium and provides them with the benefits of various types of government subsidies, loans, and other government schemes</span>, Here is the step by step process of online registration of Udyam registration which will help you to do online Udyam registration and you will be able to take various government benefits.</p>

            <ol>
               <li>
                  <strong>Step 1: Visit the <a href="/">Udyam Registration Portal</a></strong>
                  <p>To start the online registration process, first, you need to visit our Udyam Portal.</p>
               </li>
               <li>
                  <strong>Step 2: Choose Your Registration Type</strong>
                  <ul>
                        <li><strong>New Entrepreneur:</strong> If you are registering for Udyam for the first time, click on the <strong><a href="#main-form">“New Udyam Registration”</a></strong> tab to start your registration process.</li>
                        <li><strong>Existing Udyam:</strong> If your business is already registered under EM-II or UAM, apply for <strong><a href="/udyam-re-registration-certificate-online.php">“Udyam Re-Registration”</a></strong> to renew the existing Udyam.</li>
                  </ul>
               </li>
               <li>
                  <strong>Step 3: Fill in the Basic Details</strong>
                  <p>Applicant should his name, mobile number, email, gender, social category, state, district, pin code, etc.</p>
               </li>
               <li>
                  <strong>Step 4: Fill in the Business Details</strong>
                  <p>After filling in the basic details, the applicant has to provide the following details of his business:</p>
                  <ul>
                        <li>Business name</li>
                        <li>Type of organization</li>
                        <li>Business activity (manufacturing or service)</li>
                        <li>PAN card details</li>
                        <li>Business location (State, District, Pincode)</li>
                        <li>Date of business commencement</li>
                        <li>Bank account details (Account Number & IFSC Code)</li>
                  </ul>
               </li>
               <li>
                  <strong>Step 5: Enter Aadhaar Details</strong>
                  <p>Aadhaar is a very important document for Udyam Registration and it varies based on ownership:</p>
                  <ul>
                        <li><strong>For Proprietorship:</strong> The owner himself has to provide the Aadhaar.</li>
                        <li><strong>For Partnership Firm:</strong> Aadhaar details of Managing Partner have to be provided.</li>
                        <li><strong>Company/LLP:</strong> In the case of Company or LLP, the Aadhaar card details of the authorized signatory have to be provided.</li>
                  </ul>
               </li>
               <li>
                  <strong>Step 6: Enter Investment and Turnover</strong>
                  <p>Investment and turnover figures play an important role in classifying businesses into micro, small, or medium so, provide details of your business investment in plant and machinery or equipment and its annual turnover.</p>
               </li>
               <li>
                  <strong>Step 7: Review and Declaration</strong>
               ...
               <li>
                  <strong>Step 8: Submit and Get the Udyam Registration Certificate</strong>
                  <p>Click the <strong>“Submit”</strong>and Pay the Consultancy fee payment to begin the Udyam Registration Process.
                  <br>
                  The Udyam registration process will start immediately, Once the payment process is completed. During the process, we will need 2-3 OTPs to validate your documents and business details, for which one of our executives will remain in touch with you.
                  <br>
                  You can <a href="/track-order.php">Track your Application Status</a> during processing and receive the Udyam Registration Number (URN) and Udyam Registration Certificate in your registered email address.
                  </p>
               </li>
            </ol>


            <h4>How many days will it take to get an MSME certificate?</h4>
            <p><span style="background-color: yellow; font-style: italic;">Udyam Registration process starts instantly, once the payment process is completed we usually provide Udyam Certificate within <b>24 business hours</b></span> but in rare cases where we require additional verification or face technical issues, the process may take 2-3 days.</p>

            <h4>Eligibility for Udyam Registration</h4>
            <b>There are various criteria for Udyam Registration which must be fulfilled:</b><br>
            Classification of businesses based on investment and turnover:
            <ul>
               <li><strong>Micro Enterprises:</strong> Industries with investment up to ₹1 crore and Turnover: up to ₹5 crore are classified as Micro Enterprises.</li>
               <li><strong>Small Enterprises:</strong> Industries with investments up to ₹10 crore and Turnover: up to ₹50 crore are classified as Small Enterprises.</li>
               <li><strong>Medium Enterprises:</strong> Industries with investments up to ₹50 crore and Turnover: up to ₹250 crore are classified as Medium Enterprises.</li>
            </ul>

            <h4>Documents required for different types of businesses</h4>
            <p>The documents as are necessary for Udyam registration vary depending on the type of business registration such as:</p>
            <ul>
               <li><strong>Proprietorship:</strong> Aadhaar Card, PAN Card, Bank Account details.</li>
               <li><strong>Partnership Firm:</strong> Aadhaar of authorized signatory, PAN of the firm, Business deed, Bank details.</li>
               <li><strong>Private Limited Company or LLP:</strong> Aadhaar, PAN, Certificate of incorporation, Business address proof, GSTIN (if applicable).</li>
               <li><strong>Society or Trust:</strong> Aadhaar, PAN, Registration certificate, Bank details, Business address proof, GSTIN (if applicable).</li>
            </ul>

            <h4>Validity of Udyam Registration</h4>
            <p>The Udyam Registration Certificate is <span style="background-color: yellow; font-style: italic;">Valid for Lifetime</span> and does not require renewal.
               <br>
            However, we also suggest that in case of any change in investment, turnover, or business details in the future, you should update all the information in the Udyam Certificate through the Udyam Portal so that you do not miss out on any government benefits.</p>

            <h4>Benefits of Udyam Registration</h4>
            <ul>
               <li>Registering a Udyam gets the business recognized as an MSME thereby increasing business credibility.</li>
               <li>Udyam registration ensures access to government schemes and subsidies.</li>
               <li>Offers loans without any guarantee under the Credit Guarantee Fund Scheme</li>
               <li>Exemption on taxes.</li>
               <li>Offers subsidy on patent registration and industrial incentives.</li>
               <li>Lower interest rates on business loans and overdrafts.</li>
               <li>Offers protection against late payments from buyers under the MSME Act.</li>
               <li>Exemption on electricity bills and ISO certification fees.</li>
            </ul>
            </div>
            <h4>How we can help with Udyam Registration</h4>
            <p>
               Udyam Registration is a very complex and time-consuming process which increases the chances of mistakes during registration. We have a team of experienced experts to provide you end-to-end assistance. <strong><a href="/contact-us.php">Contact Us</a></strong> for a hassle-free registration experience and unlock continued benefits for your MSME.
            </p> -->
            <br>
      </section>
