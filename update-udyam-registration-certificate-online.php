...
<html lang="en">
   ...
   <body>
      ...
      <img src="/assets/image/update-udyam-registration.webp" alt="update or edit udyam registration certificate online" class="img w-100" />
               ...
               <div class="col-lg-7 col-md-12">
                  <div class="card rounded-0">
                     <div class="card-header rounded-0 text-center p-2 text-white brown">
                        <h2 style="font-size:19px; font-weight: bold;">Update & Edit Udyam Certificate Form</h2>
                     </div>
               ...
               <div class="col-lg-5 col-md-12 mt-4 mt-lg-0">
                  <div class="card card_instruction">
                     <div class="card-header text-center">
                        <h3>READ THE INSTRUCTIONS TO FILL UPDATE UDYAM FORM</h3>
                     </div>
